...
! ***********************************************************************
      ...
      subroutine penetrative_convection(id, ierr)
          ...
          first_model_number = 10000

          ! When it load a photo, with a significant different mesh size,
          ! it could be a problem to use this routine
          !if (s% model_number == first_model_number) return
